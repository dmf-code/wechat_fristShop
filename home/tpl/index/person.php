...
require_once ROOT_PATH . '/home/tpl/public/header.php';
     ...
     */
    global $dcache;
    $tpl_tab3 = $dcache->getVal('userinfo');

    $pendingPayment = $dcache->getVal('pendingPayment');
    $pendingDelivery = $dcache->getVal('pengingDelivery');

    $pendingDelivery2 = $dcache->getVal('pengingDelivery2');

    $toBeEvaluated = $dcache->getVal('toBeEvaluated');
?>
...
<div class="weui-cells">
    <div class="weui-cell">
        <div class="weui-cell__hd">
            <img style="height: 4em;width: 4em;border-radius:100%;" src="<?php echo $tpl_tab3['headimgurl']; ?>">
        </div>
        <div class="weui-cell__bd" style="text-align: center;">
            <p>用户名：<?php echo $tpl_tab3['nickname'];?></p>
            <p>会员：黄金会员</p>
            <p>积分：0</p>
        </div>
    </div>
        ...
        <div class="weui-cell__bd">
            <div class="weui-flex">
                <div class="weui-flex__item">
                    <a href="http://wx.dmf95.cn/fruitShop/index.php/order/order/pendingPayment">
                        <div class="area">
                            <?php
                ...
                <div class="weui-flex__item">
                    <a href="http://wx.dmf95.cn/fruitShop/index.php/order/order/pendingDelivery">
                        <div class="area">
                            <?php
                ...
                <div class="weui-flex__item">
                    <a href="http://wx.dmf95.cn/fruitShop/index.php/order/order/pendingDelivery2">
                        <div class="area">
                            <?php
                ...
                <div class="weui-flex__item">
                    <a href="http://wx.dmf95.cn/fruitShop/index.php/order/order/toBeEvaluated">
                        <div class="area">
                            <?php
        ...
        <div class="weui-cell__bd">
            <div class="weui-panel weui-panel_access">
                <div class="weui-panel__bd">
                    <a href="/fruitShop/index.php/home/address/showAddress" class="weui-media-box weui-media-box_appmsg">
...
<div>
    <div class="weui-cell">
        <div class="weui-cell__bd">
            <div class="weui-panel weui-panel_access">
                <div class="weui-panel__bd">
                    <a href="/fruitShop/index.php/order/buyNow/index" class="weui-media-box weui-media-box_appmsg">
                        <div class="weui-media-box__hd">
